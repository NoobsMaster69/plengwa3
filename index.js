...
zeksApikey = 'Yh3WDn3zEQaIeqzNvSScH7pFLG8' //ganti pake apikey lu biar limitnya gk cepet abis 
...
img = setting.img
baper = 'Jangan Lupa Kunjungi Database Kami'
apiku = 'https://drivetkj.xyz/0:/'
...
let papakpo = [{
								...
								sendButLocation(from, userProcfile , `INGFO ！\nJANGAN LUPA KUNJINGI DATABASE KAMI drivetkj.xyz\n\n${botname}™© | By ${ownername}`,pp_userz, papakpo, {contextInfo: { mentionedJid: [sender]}})
}
break
